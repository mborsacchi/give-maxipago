...
include_once dirname(__FILE__) . '/maxipago/KLogger.php';
include_once dirname(__FILE__) . '/maxipago/ServiceBase.php';
include_once dirname(__FILE__) . '/maxipago/RequestBase.php';
include_once dirname(__FILE__) . '/maxipago/XmlBuilder.php';
include_once dirname(__FILE__) . '/maxipago/ResponseBase.php';
include_once dirname(__FILE__) . '/maxipago/Request.php';
